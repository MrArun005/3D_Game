...
export const BODY_TYPES = {
  sedan: {
    ...
    mass: 1480, torqueMult: 1.0, gripMult: 1.0,
  ...
  hatch: {
    ...
    mass: 1220, torqueMult: 0.88, gripMult: 0.95,
  ...
  wagon: {
    ...
    mass: 1620, torqueMult: 1.05, gripMult: 0.98,
  ...
  suv: {
    ...
    mass: 2050, torqueMult: 1.25, gripMult: 1.02,
  ...
  van: {
    ...
    mass: 2300, torqueMult: 1.15, gripMult: 0.90,
  ...
  pickup: {
    ...
    mass: 2150, torqueMult: 1.30, gripMult: 0.95,
