...
export function createGrade(renderer, scene, camera, {
  ...
  if (withAO) {
    ...
    /* Half-resolution AO (2026-09-22): GTAO ran at full resolution with 16
       samples on every pixel, the most expensive pass in the frame. GTA V
       computes SSAO at half res too; the denoiser hides the upscale. */
